...
public class JavaScriptTemplateV7Test {
    private static final String ODT_FIELD_SIMPLE = "/template-v7-field-simple.odt";
    private static final String ODT_FIELD_AS_STR = "/template-v7-field-str.odt";
    private static final String ODT_FIELD_ENCODE = "/template-v7-field-enc.odt";
    private static final String ODT_FIELD_OOXML = "/template-v7-field-ooxml.odt";
    private static final String FIELD_NAME = "fieldStr";

    private static final String ODT_TAG_PARAGRAPH = "/template-v7-tag-paragraph.odt";
    private static final String ODT_TAG_SECTION = "/template-v7-tag-section.odt";
    private static final String ODT_TAG_TABLE = "/template-v7-tag-table.odt";
    private static final String ODT_TAG_LIST_ITEM = "/template-v7-tag-list-item.odt";
    private static final String ODT_TAG_TABLE_ROW = "/template-v7-tag-table-row.odt";

    private static final String ODT_REPEAT_PARAGRAPH = "/template-v7-repeat-paragraph.odt";
    private static final String ODT_REPEAT_SECTION = "/template-v7-repeat-section.odt";
    private static final String ODT_REPEAT_TABLE = "/template-v7-repeat-table.odt";
    private static final String ODT_REPEAT_LIST_ITEM = "/template-v7-repeat-list-item.odt";
    private static final String ODT_REPEAT_TABLE_ROW = "/template-v7-repeat-table-row.odt";
